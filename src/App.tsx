...
import ModeHeader, { type Mode } from './ModeHeader';
...
export default function App(): JSX.Element | null {
  ...
  if (mode === 'study') {
    ...
    return (
      <div className="min-h-screen bg-gray-950 text-white flex flex-col">
        <ModeHeader mode={mode} selectedKey={selectedKey} onKeySwitch={handleKeySwitch} onModeSwitch={handleModeSwitch} />
        <div className="flex-1 flex flex-col items-center justify-start pt-6 px-4 gap-6">
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white flex flex-col">
      <ModeHeader mode={mode} selectedKey={selectedKey} answered={answered} sessionTotal={SESSION_LENGTH} onKeySwitch={handleKeySwitch} onModeSwitch={handleModeSwitch} />
